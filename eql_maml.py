...
class Benchmark(BaseBenchmark):
    ...
    def meta_learn(self, func_names, trials, val_func_name=None):
...
#        scheduler = torch.optim.lr_scheduler.MultiplicativeLR(opt, lr_lambda=scheduler_function)
        ...
        if self.train_mode == "maml":
            ...
            for counter in range(self.n_epochs1):
                ...
                opt.step()
#                scheduler.step()
                if val_func_name is not None:
                    # Validation step
                    func = equation_dict[val_func_name]
...
if __name__ == "__main__":
    ...
    if kwargs['exp_number'] == 1:
        ...
        func_names = None
    bench.meta_learn(func_names=func_names, trials=10, val_func_name=val_func_name)
